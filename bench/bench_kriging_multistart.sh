...
# Benchmark script for Kriging BFGS multistart optimization
...
echo "╔════════════════════════════════════════════════════════════════════════╗"
echo "║         Kriging Multistart Benchmark (n=$DATASET_SIZE)                  ║"
echo "╚════════════════════════════════════════════════════════════════════════╝"
echo ""
...
# Compile benchmark
echo "Compiling Kriging benchmark..."
...
g++ -std=c++17 -O2 -fopenmp -DARMA_32BIT_WORD \
    "$SCRIPT_DIR/bench_kriging_multistart.cpp" \
    -o "$BUILD_DIR/bench_kriging_multistart" \
...
"$BUILD_DIR/bench_kriging_multistart" "$DATASET_SIZE" "$N_RUNS"
