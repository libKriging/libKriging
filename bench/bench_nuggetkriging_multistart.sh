...
# Benchmark script for NuggetKriging BFGS multistart optimization
...
echo "╔════════════════════════════════════════════════════════════════════════╗"
echo "║      NuggetKriging Multistart Benchmark (n=$DATASET_SIZE)               ║"
echo "╚════════════════════════════════════════════════════════════════════════╝"
echo ""
...
# Compile benchmark
echo "Compiling NuggetKriging benchmark..."
...
g++ -std=c++17 -O2 -fopenmp -DARMA_32BIT_WORD \
    "$SCRIPT_DIR/bench_nuggetkriging_multistart.cpp" \
    -o "$BUILD_DIR/bench_nuggetkriging_multistart" \
...
"$BUILD_DIR/bench_nuggetkriging_multistart" "$DATASET_SIZE" "$N_RUNS"
