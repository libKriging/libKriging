...
def test_data1():
    ...
    kernel = "gauss"
    r = lk.PyKriging(y, X, kernel, lk.RegressionModel.Constant, False, "BFGS", "LL", lk.Parameters())
...
def test_data2(i):
    ...
    kernel = "gauss"
    r = lk.PyKriging(y, X, kernel)  # use defaults: lk.RegressionModel.Constant, False, "BFGS", "LL", lk.Parameters())
