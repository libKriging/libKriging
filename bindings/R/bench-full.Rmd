...
for (i in 1:length(logn)) {
 ...
 # print(n)
  ...
  if (abs(ll_cpp - DiceKriging::leaveOneOutFun(param=as.numeric(kriging_model(r)$theta),model=k))/ll_cpp>.1)
    warning("LOO function is not the same bw DiceKriging/libKriging: ",kriging_leaveOneOut(r,kriging_model(r)$theta)," vs. ",DiceKriging::leaveOneOutFun(param=as.numeric(kriging_model(r)$theta),model=k))  
