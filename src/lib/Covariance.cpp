...
std::function<double(const arma::fvec&, const arma::fvec&)> Covariance::Cov_gauss
...
std::function<double(const arma::fvec&, const arma::fvec&)> Covariance::Cov_exp
...
std::function<double(const arma::fvec&, const arma::fvec&)> Covariance::Cov_matern32
    = [](const arma::fvec& _dX, const arma::fvec& _theta) {
...
std::function<double(const arma::fvec&, const arma::fvec&)> Covariance::Cov_matern52
    = [](const arma::fvec& _dX, const arma::fvec& _theta) {
...
std::function<double(const arma::fvec&, const arma::fvec&)> Covariance::Cov_whitenoise
    = [](const arma::fvec& _dX, const arma::fvec& _theta) {
