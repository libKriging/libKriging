...
class Covariance {
 public:
  static std::function<double(const arma::fvec&, const arma::fvec&)> Cov_gauss;
  ...
  static std::function<double(const arma::fvec&, const arma::fvec&)> Cov_exp;
  ...
  static std::function<double(const arma::fvec&, const arma::fvec&)> Cov_matern32;
  ...
  static std::function<double(const arma::fvec&, const arma::fvec&)> Cov_matern52;
  ...
  static std::function<double(const arma::fvec&, const arma::fvec&)> Cov_whitenoise;
