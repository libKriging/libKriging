...
class NestedKriging {
 public:
   ...
   * @param dydX optional n*d matrix of observed gradients (see
 ...
 private:
  ...
  void unify_hyperparameters(const std::string& objective, const std::optional<arma::mat>& dydX = std::nullopt);
  void precompute_nk();
